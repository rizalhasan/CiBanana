    ...
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <a class="brand" href="<?= base_url('Admin/beranda')?>">
                ...
                <div class="span3">
                    <div class="sidebar">
                        <ul class="widget widget-menu unstyled">
                            ...
                            <li><a href="<?= base_url('Admin/isiKategori')?>"><i class="menu-icon"></i>Kategori</a></li>
                            ...
                            <li><a href="<?= base_url('Admin/artikel')?>"><i class="menu-icon"></i>Artikel</a></li>
                            <li><a href="#"><i class="menu-icon"></i>Logout</a></li>
                        </ul>
                        <!--/.widget-nav-->
                    </div>
